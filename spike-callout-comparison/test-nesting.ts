...
const mditHtml = parseWithMarkdownIt(nestedCallout)
console.log(mditHtml)
console.log()

console.log('--- Marked.js ---')
const markedHtml = parseWithMarked(nestedCallout)
...
console.log('--- markdown-it ---')
console.log(parseWithMarkdownIt(listBody))

console.log('--- Marked.js ---')
console.log(parseWithMarked(listBody))
...
console.log('--- markdown-it ---')
console.log(parseWithMarkdownIt(tripleNested))

console.log('--- Marked.js ---')
console.log(parseWithMarked(tripleNested))
